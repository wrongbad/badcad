...
class Shape:
    ...
    def extrude_edges(self, height, radius, style='round', top=True, bottom=True, fn=0):
        """Extrude with rounded or 45 degree chamfered top and bottom edges.

        Works for any shape: several polygons, and polygons with holes.
        The side walls follow the shape; convex corners in plan get a
        radius of `radius`. style is 'round' or 'chamfer'. Set top or
